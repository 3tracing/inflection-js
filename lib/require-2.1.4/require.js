    ...
    function ea(b) {
        ...
        k = {config: m, contextName: b, registry: j, defined: p, urlFetched: S, defQueue: G, Module: W, makeModuleMap: h, nextTick: l.nextTick, configure: function(a) {
            ...
            function g(e, c, u) {
                ...
                if ("string" === typeof e) {
                    if (I(c))return A(F("requireargs", "Invalid require-2.1.4 call"), u);
                    if (a && r(N, e))return N[e](j[a.id]);
                    if (l.get)return l.get(k, e, a);
                    i = h(e, a, !1, !0);
                    i = i.id;
                    return!r(p, i) ? A(F("notloaded", 'Module name "' + i + '" has not been loaded yet for context: ' + b + (a ? "" : ". Use require-2.1.4([])"))) : p[i]
                }
                K();
                k.nextTick(function() {
                    K();
    ...
    if ("undefined" === typeof define) {
        ...
        define = function(b, c, d) {
            ...
            !c.length && I(d) && d.length && (d.toString().replace(ia, "").replace(ja, function(b, d) {
                c.push(d)
            }), c = (1 === d.length ? ["require-2.1.4"] : ["require-2.1.4", "exports", "module"]).concat(c));
            if (O) {
